...
router.get('/walkers/summary', async (req, res) => {
  try {
    const [openWalkRequests] = await db.execute(`SELECT Users.username AS walker_username, total_ratings FROM Users INNER JOIN WalkRatings ON Users.user_id = WalkRatings.walker_id GROUP BY `);
    res.json(openWalkRequests);
  } catch (err) {
